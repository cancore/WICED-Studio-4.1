 ...
 * and hci_control application running on 20706. Please refer to the WICED HCI Control
 * Protocol Software User Manual (WICED-SWUM10x-R) for additional details on the
