...
BUILD_STRING ?= $(strip $(filter-out $(MAKEFILE_TARGETS) debug download download_apps download_only run terminal no_dct no_tinybl ota2_image ota2_download ota2_factory_image ota2_factory_download ota2_manuf_image ota2_manuf_download, $(MAKECMDGOALS)))
