...
static uint8_t buffer_pool_memory_128 [WICED_PACKET_POOL_SIZE_128 + PLATFORM_L1_CACHE_BYTES];
static uint8_t buffer_pool_memory_common [APP_COM_BUFFER_POOL_SIZE + PLATFORM_L1_CACHE_BYTES];
#else
