...
static besl_result_t p2p_join_group_owner( p2p_workspace_t* workspace )
{
    ...
    if ( result != WWD_SUCCESS)
    {
        ...
        result = (wiced_result_t) wwd_wifi_join( &workspace->group_owner.scan_result.SSID, workspace->group_owner.scan_result.security, (uint8_t*) workspace->p2p_passphrase, workspace->p2p_passphrase_length, NULL, WWD_P2P_INTERFACE );
    }
