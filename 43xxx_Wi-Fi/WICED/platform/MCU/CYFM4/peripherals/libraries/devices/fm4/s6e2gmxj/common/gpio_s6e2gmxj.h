 ...
 **
 ** Header file for S6E2GMXJ GPIO functions, included in gpio.h
 **
 ** History:
...
#define GPIO1PIN_NP48_INITOUT(v)        do{ \
                                            bFM_GPIO_PDOR4_P8=(uint32_t)(!((uint32_t)(v).bInitVal)); \
                                            bFM_GPIO_DDR4_P8=1u; \
                                            bFM_GPIO_PFR4_P8=0u; }while(0u)
...
/*--- MI2SCK1_0 ---*/
#define SetPinFunc_MI2SCK1_0(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 20u, 2u,  1u ); \
                                            bFM_GPIO_PFR4_PA = 1u; \
                                        }while (0u)

/*--- MI2SCK1_1 ---*/
#define SetPinFunc_MI2SCK1_1(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 20u, 2u,  2u ); \
                                            bFM_GPIO_PFR5_PF = 1u; \
                                        }while (0u)

/*--- MI2SDI1_0 ---*/
#define SetPinFunc_MI2SDI1_0(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 24u, 2u,  1u ); \
                                            bFM_GPIO_PFR4_P8 = 1u; \
                                        }while (0u)

/*--- MI2SDI1_1 ---*/
#define SetPinFunc_MI2SDI1_1(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 24u, 2u,  2u ); \
                                            bFM_GPIO_PFR5_PD = 1u; \
                                        }while (0u)

/*--- MI2SDO1_0 ---*/
#define SetPinFunc_MI2SDO1_0(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 26u, 2u,  1u ); \
                                            bFM_GPIO_PFR4_P9 = 1u; \
                                        }while (0u)

/*--- MI2SDO1_1 ---*/
#define SetPinFunc_MI2SDO1_1(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 26u, 2u,  2u ); \
                                            bFM_GPIO_PFR5_PE = 1u; \
                                        }while (0u)

/*--- MI2SMCK1_0_IN ---*/
#define SetPinFunc_MI2SMCK1_0_IN(dummy) do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 16u, 2u,  1u ); \
                                            bFM_GPIO_PFR4_PC = 1u; \
                                        }while (0u)

/*--- MI2SMCK1_0_OUT ---*/
#define SetPinFunc_MI2SMCK1_0_OUT(dummy)do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 18u, 2u,  1u ); \
                                            bFM_GPIO_PFR4_PC = 1u; \
                                        }while (0u)

/*--- MI2SMCK1_1_IN ---*/
#define SetPinFunc_MI2SMCK1_1_IN(dummy) do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 16u, 2u,  2u ); \
                                            bFM_GPIO_PFR3_P1 = 1u; \
                                        }while (0u)

/*--- MI2SMCK1_1_OUT ---*/
#define SetPinFunc_MI2SMCK1_1_OUT(dummy)do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 18u, 2u,  2u ); \
                                            bFM_GPIO_PFR3_P1 = 1u; \
                                        }while (0u)

/*--- MI2SWS1_0 ---*/
#define SetPinFunc_MI2SWS1_0(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 22u, 2u,  1u ); \
                                            bFM_GPIO_PFR4_PB = 1u; \
                                        }while (0u)

/*--- MI2SWS1_1 ---*/
#define SetPinFunc_MI2SWS1_1(dummy)     do{ \
                                            PINRELOC_SET_EPFR( FM_GPIO->EPFR35, 22u, 2u,  2u ); \
                                            bFM_GPIO_PFR3_P0 = 1u; \
                                        }while (0u)
...
#define GPIO1PIN_S_CD_0                 GPIO1PIN_P39
