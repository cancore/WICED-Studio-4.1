...
typedef struct
{
    ...
    wiced_bt_wifi_introducer_address_type_t     address_type; /**< Peer device's address type                                                                            */
...
} wiced_bt_wifi_introducer_bond_info_t;

typedef struct
{
    wiced_bt_wifi_introducer_bond_info_t    bond_info[MAX_BOND_INFO]; /* Bond information                      */
