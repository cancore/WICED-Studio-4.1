...
typedef enum
{
    WICED_UART_1,   /* MFS UART Channel 0 */
    WICED_UART_2,   /* MFS UART Channel 1 */
    WICED_UART_3,   /* MFS UART Channel 2 */
    WICED_UART_4,   /* MFS UART Channel 3 */
    WICED_UART_5,   /* MFS UART Channel 4 */
    WICED_UART_6,   /* MFS UART Channel 5 */
    WICED_UART_7,   /* MFS UART Channel 6 */
    WICED_UART_8,   /* MFS UART Channel 7 */
    WICED_UART_9,   /* MFS UART Channel 8 */
    WICED_UART_10,  /* MFS UART Channel 9 */
