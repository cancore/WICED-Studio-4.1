...
//                printf(" ### Disconnect socket = [0x%X] \n", (unsigned int)current_event.socket->socket.nx_tcp_socket_id);
...
//                        printf(" ### Created socket = [0x%X] \n", (unsigned int)stream->stream.response.tcp_stream.socket->socket.nx_tcp_socket_id);
                    }
