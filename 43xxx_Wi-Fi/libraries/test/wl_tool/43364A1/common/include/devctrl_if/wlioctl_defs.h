 ...
 *
 * $Id: wlioctl_defs.h 403826 2013-05-22 16:40:55Z xwei $
 */
...
#define WPA_AUTH_WAPI           0x0400 /* XXX why it is same as WAPI_AUTH_UNSPECIFIED */
...
#define WLC_ECHO				323
#define WLC_LAST				324	/* XXX The last ioctl. Also push this
...
#define WLC_BW_2P5MHZ_BIT		(1<<4)
#define WLC_BW_5MHZ_BIT			(1<<5)
#define WLC_BW_10MHZ_BIT		(1<<6)
...
#define BCMIO_NBBY		8
#define WL_EVENTING_MASK_LEN	16		/* XXX Don't increase this without wl review */
