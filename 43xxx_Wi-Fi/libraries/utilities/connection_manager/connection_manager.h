...
typedef enum
{
    ...
    CONNECTION_P2P_GC_LEGACY        = 0x1 << 2,
    CONNECTION_WPS_REGISTRAR        = 0x1 << 3,
    CONNECTION_WPS_ENROLLEE         = 0x1 << 4,
    CONNECTION_WPS_ENROLLEE_LEGACY  = 0x1 << 5,
} connection_status_t;
...
/*****************************************************************************/
/**
 *  @defgroup   connection_manager   Connection Manager
 *  @ingroup    wifi
 *
 *  @addtogroup wfd_cm               Wi-Fi (802.11) P2P connection functions
...
/* @cond */
/** MCU powersave for a given period of milliseconds.
 *
 * This functions makes MCU to sleep to save power.
 *
 * @param[in] sleep_ms      : How much time let MCU get sleep. 0 means forever.
 *
 * @return    WICED_SUCCESS : on success.
 * @return    WICED_ERROR   : if an error occurred.
 */
