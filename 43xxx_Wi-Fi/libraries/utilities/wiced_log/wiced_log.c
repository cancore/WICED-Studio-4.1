...
wiced_result_t wiced_log_set_level(WICED_LOG_LEVEL_T level)
{
    wiced_result_t result = WICED_SUCCESS;
...
wiced_result_t wiced_log_msg(WICED_LOG_LEVEL_T level, const char *fmt, ...)
{
    wiced_result_t result = WICED_SUCCESS;
    wiced_time_t now;
    ...
    wiced_jump_when_not_true( ((wiced_log.loglevel != WICED_LOG_OFF) && (level <= wiced_log.loglevel)), _exit);
