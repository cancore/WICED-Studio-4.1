...
void <device_name>_create(void)
{
    ...
    if(sizeof(<device_name>_uuid_main_service) > 1)
    {
		...
		adv[1].len     = sizeof(<device_name>_uuid_main_service) + 1;
		adv[1].val     = sizeof(<device_name>_uuid_main_service) == 16 ? ADV_SERVICE_UUID128_COMP : ADV_SERVICE_UUID16_COMP;
		memcpy(adv[1].data, &<device_name>_uuid_main_service[0], sizeof(<device_name>_uuid_main_service));
...
void <device_name>_connection_up(void)
{
	...
	// changed_<service_name>_<char_name>() generated by BT designer
